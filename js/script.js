...
const whatinmybagTitle = createNode('h2', { className: 'whatinmybag-title' }, whatInMyBagData.title);
...
const footerLinks = createNode('div', { className: 'footer-links' });
const footerSocials = createNode('div', { className: 'footer-socials' });

const privacyPolicyLink = createNode('a', { href: 'privacy-policy.html' }, 'Privacy Policy');
footerLinks.appendChild(privacyPolicyLink);
